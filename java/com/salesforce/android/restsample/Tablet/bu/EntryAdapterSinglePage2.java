...
// */
//public class EntryAdapterSinglePage2 extends ArrayAdapter<ItemSinglePage> {
//
...
//
//    public EntryAdapterSinglePage2(Context context, ArrayList<ItemSinglePage> items) {
...
//
//                // set Detail Start
//                SectionItemSinglePage city = (SectionItemSinglePage) getItem( position );
//                ViewSection viewCache;
//
//                if ( convertView == null ) {
//                    resourceSection = R.layout.section_activity_product_hor;
//                    convertView = ( RelativeLayout ) inflater.inflate(resourceSection, null );
//                    viewCache = new ViewSection( convertView );
//                    convertView.setTag( viewCache );
//                }
//                else {
//                    convertView = (RelativeLayout) convertView;
//                    viewCache = ( ViewSection ) convertView.getTag();
//                }
//                sName = viewCache.getsName(resourceSection);
//                sName.setText(city.getName());
//
//                sAvail = viewCache.getsAvail(resourceSection);
//                sAvail.setText(city.getAvail());
//                sOnshelf = viewCache.getsOnshelf(resourceSection);
//                sOnshelf.setText(city.getOnshelf());
//                sInstock = viewCache.getsInstock(resourceSection);
//                sInstock.setText(city.getInstock());
//                sQty = viewCache.getsQty(resourceSection);
//                sQty.setText(city.getQty());
//                sFoc = viewCache.getsFoc(resourceSection);
//                sFoc.setText(city.getFoc());
//                sDis1 = viewCache.getsDis1(resourceSection);
//                sDis1.setText(city.getDiscount());
//                sAmount = viewCache.getsAmount(resourceSection);
//                sAmount.setText(city.getAmount());
//
//                // set Detail End
//
//
