...
import com.salesforce.android.restsample.Tablet.TLS12.JsonToString;
import com.salesforce.android.restsample.Tablet.TLS12.TLS12;
...
public class HTTPGetProgressBarSQLiteDB3FragmentTLS extends Fragment{// implements View.OnClickListener {
...
//    }
    ...
    class AsyncT extends AsyncTask<String, String, Void> { // Print 1 start
        ...
        protected Void doInBackground(String... f_url) {
            ...
            okHTTPclient = tls12.getNewHttpClient(); // USE!

            /* config TLS 1.2 */
            /* POST */
            RequestBody formBody = new FormBody.Builder()
                    .add("Authorization", "Authorization: Bearer "+myTokens.get_access_token())
...
//                    .build();
            ...
            /* GET */
            Request request = new Request.Builder()
                    .header("Authorization", "Authorization: Bearer "+ myTokens.get_access_token())
...
//                Log.e("Chk_HTTPGet3: ", "Chk_jsonResult:_" + jsonResult);
                ...
                Log.e("RESTfulClient", "RESTfulClient_response:_" + response.toString());

                String jsonResult = json2Str.inputStreamToString(response.body().byteStream()).toString();
                Log.e("RESTfulClient", "RESTfulClient_jsonResult:_" + jsonResult);
...
//            HttpGet httpGetImg = new HttpGet(downloadUrl);
            ...
            /* config TLS 1.2 */
            okHTTPclient = tls12.getNewHttpClient();
...
//                Log.e("Check Salesvisit Array", "Run_AsyncTGETSalesVisit()_jsonResult ----- After: " + jsonResultSV);
                ...
                jsonResultSV = json2Str.inputStreamToString(response.body().byteStream()).toString();
                Log.e("RESTfulClient", "RESTfulClient_jsonResultSV:_" + jsonResultSV);
...
//            progressBar5.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
            progressBar5.setProgress(Integer.parseInt(value[0]) + 5);
            progressBar5.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
        }
...
//                Log.e("Check AccountInfo Array", "Run_AsyncTGETAccountInfo()_jsonResult ----- After: " + jsonResultAC);
                ...
                jsonResultAC = json2Str.inputStreamToString(response.body().byteStream()).toString();
                Log.e("RESTfulClient", "RESTfulClient_jsonResultAC:_" + jsonResultAC);
...
//                Log.e("Check AccountInfo Array", "Run_AsyncTPOSTAccountInfo()_jsonResult ----- After: " + jsonResultAC);
               ...
               RequestBody formBody = RequestBody.create(JSON, jsonObjPOST.toString());
...
//                        .add("Authorization", "Authorization: Bearer "+myTokens.get_access_token())
//                        .add("Content-Type", "application/json")
//                        // .add("accountIdList",jsonArPOST.toString())
//                        .add(JSON,jsonObjPOST)
//                        .build();
                ...
                jsonResultAC = json2Str.inputStreamToString(response2.body().byteStream()).toString();
                Log.e("RESTfulClient", "RESTfulClient_jsonResultAC:_" + jsonResultAC);
...
//                            }
        ...
        protected void onProgressUpdate(String... value) {
            ...
            progressBar6.setProgress(Integer.parseInt(value[0]) + 5);
            progressBar6.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
        }
...
//                Log.e("Check Invoice Array", "Run_AsyncTGETInvoice()_jsonResult ----- After: " + jsonResultInv);
                ...
                jsonResultInv = json2Str.inputStreamToString(response.body().byteStream()).toString();
                Log.e("RESTfulClient", "RESTfulClient_jsonResultInv:_" + jsonResultInv);
...
//            progressBar7.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
            progressBar7.setProgress(Integer.parseInt(value[0]) + 5);
            progressBar7.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
        }
...
//                    Log.e("Check Account Array", "Run_AsyncTPOSTAccount()_jsonResult ----- After: " + jsonResultAC);
        ...
        protected void onProgressUpdate(String... value) {
            // progressBar6.setSecondaryProgress(Integer.parseInt(value[0]) + 2);
            progressBar8.setProgress(Integer.parseInt(value[0]) + 5);
            progressBar8.setSecondaryProgress(Integer.parseInt(value[0]) + 2);

            progressBar8.setProgress(80);
        }
...
//                    Log.e("Check SalesVisit Array", "Run_AsyncTPOSTSalesVisit()_jsonResult ----- After: " + jsonResultSV);
                    ...
                    jsonResultSV = json2Str.inputStreamToString(response.body().byteStream()).toString();
                    Log.e("RESTfulClient", "RESTfulClient_jsonResult:_" + jsonResultSV);
